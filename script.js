...
function gerarPDF(botao) {
    ...
    // Se posicao_categoria é '0' ou 0, esconde o parágrafo
    if (dados.posicao_categoria === '0' || dados.posicao_categoria === 0) {
        document.getElementById('cert-posicao-categoria-p').style.display = 'none';
    } else {
        document.getElementById('cert-posicao-categoria-p').style.display = 'block';
